...
namespace ViewPortTools
{
    ...
    public class HitTestEdge
    {
        ...
        {
            Point3D projPoint1 = objectToViewportTransform.Transform(P1);
            Point3D projPoint2 = objectToViewportTransform.Transform(P2);

            P1Transformed = new Point(projPoint1.X, projPoint1.Y);
            P2Transformed = new Point(projPoint2.X, projPoint2.Y);
        }

        public Point3D P1, P2;
        public Point Uv1, Uv2;

        // the transformed Point3D value
        public Point P1Transformed, P2Transformed;
    }
    ...
    public class InteractiveVisual3D : ModelVisual3D
    {
        ...
        {
            DefaultMaterialPropertyValue = new DiffuseMaterial();
            DefaultMaterialPropertyValue.SetValue(InteractiveVisual3D.IsInteractiveMaterialProperty, true);
            DefaultMaterialPropertyValue.Freeze();

            MaterialProperty = DependencyProperty.Register("Material",
                                                           typeof(Material),
                                                           typeof(InteractiveVisual3D),
                                                           new PropertyMetadata(DefaultMaterialPropertyValue, 
        ...
        /// </summary>
        private static DependencyProperty _visualProperty =
        ...
        {
            get { return (Visual)GetValue(_visualProperty); }
            set { SetValue(_visualProperty, value); }
        }
        ...
        internal static void OnVisualChanged(Object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (imv3D._visual is UIElement)
            {
                adornerDecoratorChild = (UIElement)imv3D._visual;
            }
            else
            {
                VisualDecorator visDecorator = new VisualDecorator();
                visDecorator.Content = imv3D._visual;
        ...
        /// </summary>
        private readonly static DiffuseMaterial DefaultMaterialPropertyValue;
